...
# MAGIC  
# MAGIC **Description** This notebooks make a table `.descriptive_Stroke_MI_event` containing the patients alive 1st Jan 2020 (identified using `patient_skinny_record_2`) who have had a first report of an MI or stroke **after** 31st Dec 2019 (), in each of the data tables below:
# MAGIC - HES APC;  
# MAGIC - GDPPR;  
# MAGIC - Death.
# MAGIC 
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS .dp_firstmi_event_table;

# COMMAND ----------

# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS .dp_firststroke_event_table;
...
# MAGIC 
# MAGIC CREATE OR REPLACE VIEW .validated_MI_Stroke_SNOMED AS
# MAGIC 
# MAGIC SELECT *
# MAGIC FROM VALUES
...
# MAGIC 
# MAGIC SELECT * FROM .validated_MI_Stroke_SNOMED
...
# MAGIC CREATE OR REPLACE VIEW .descriptive_primarycare_StrokeMIevent_firstall AS
# MAGIC 
...
# MAGIC inner join .validated_MI_Stroke_SNOMED t2 on (t1.CODE = t2.conceptId)
...
# MAGIC From .descriptive_primarycare_StrokeMIevent_firstall 
...
# MAGIC 
# MAGIC CREATE OR REPLACE VIEW .descriptive_HESAPC_StrokeMIevent_firstall AS
# MAGIC 
...
# MAGIC %sql
# MAGIC select count(PERSON_ID_DEID), Disease
# MAGIC From .descriptive_HESAPC_StrokeMIevent_firstall 
# MAGIC group by Disease
# MAGIC order by Disease
...
# MAGIC CREATE OR REPLACE VIEW .descriptive_death_StrokeMIevent_all AS
# MAGIC 
...
# MAGIC %sql
# MAGIC select count(PERSON_ID_DEID), Disease
# MAGIC From .descriptive_death_StrokeMIevent_all
# MAGIC group by Disease
# MAGIC order by Disease
...
# MAGIC 
# MAGIC CREATE OR REPLACE VIEW .descriptive_StrokeMIevent_firstall AS
# MAGIC 
# MAGIC with cte_gdppr AS (
...
# MAGIC left join .descriptive_primarycare_StrokeMIevent_firstall tab2 on tab1.NHS_NUMBER_DEID = tab2.PERSON_ID_DEID
# MAGIC ),
# MAGIC 
# MAGIC cte_hes AS (
# MAGIC SELECT tab2.PERSON_ID_DEID, tab2.DATE, tab2.SOURCE, tab2.MAIN_CODE, tab2.Disease, tab2.Category, tab2.Code, tab2.term, tab1.NHS_NUMBER_DEID 
# MAGIC from global_temp.dp_skinny tab1
# MAGIC left join .descriptive_HESAPC_StrokeMIevent_firstall tab2 on tab1.NHS_NUMBER_DEID = tab2.PERSON_ID_DEID
# MAGIC ),
# MAGIC 
# MAGIC cte_death AS (
# MAGIC SELECT tab2.PERSON_ID_DEID, tab2.DATE, tab2.SOURCE, tab2.MAIN_CODE, tab2.Disease, tab2.Category, tab2.Code, tab2.term, tab1.NHS_NUMBER_DEID 
# MAGIC from global_temp.dp_skinny tab1
# MAGIC left join .descriptive_death_StrokeMIevent_all tab2 on tab1.NHS_NUMBER_DEID = tab2.PERSON_ID_DEID
# MAGIC )
# MAGIC 
...
# MAGIC   SELECT *
# MAGIC   from .descriptive_StrokeMIevent_firstall
...
# MAGIC 
# MAGIC CREATE TABLE .dp_firststroke_event_table AS
# MAGIC 
# MAGIC with stroke_prev as (
# MAGIC   select distinct(PERSON_ID_DEID) AS ID, Disease
# MAGIC     FROM .descriptive_strokemi_previous_table
...
# MAGIC 
# MAGIC CREATE TABLE .dp_firstmi_event_table AS
# MAGIC 
