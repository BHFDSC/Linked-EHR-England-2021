...
# %sql
# ALTER TABLE .covid19_test_sgss  OWNER TO 
...
# %sql
# ALTER TABLE .covid19_test_hes  OWNER TO 
...
# %sql
# ALTER TABLE .covid19_test_gdppr  OWNER TO 
...
# %sql
# ALTER TABLE .covid19_test_all OWNER TO 

# COMMAND ----------

# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS .dp_covid19_test_all3
...
# MAGIC 
# MAGIC CREATE TABLE .dp_covid19_test_all3 as
# MAGIC 
# MAGIC SELECT *,
...
# MAGIC %sql
# MAGIC ALTER TABLE .dp_covid19_test_all3 OWNER TO 
