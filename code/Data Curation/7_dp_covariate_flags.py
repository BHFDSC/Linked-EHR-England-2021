...
create_table(df_obesity, table_name="covariate_flags_obesity", database_name="", select_sql_script=None)
...
create_table(df_diab, table_name="covariate_flags_diabetes", database_name="", select_sql_script=None)
