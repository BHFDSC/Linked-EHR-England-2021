...
# MAGIC FROM (
# MAGIC SELECT DISTINCT DEC_CONF_NHS_NUMBER_CLEAN_DEID as NHS_NUMBER_DEID, "deaths" as data_table, 1 as presence FROM .dp_deaths_
# MAGIC union all
# MAGIC SELECT DISTINCT PERSON_ID_DEID as NHS_NUMBER_DEID, "sgss" as data_table, 1 as presence FROM .dp_sgss_
# MAGIC union all
