...
table_list = [
            {'table':'hes_apc_2021_','extra_columns':'','date_cutoff_col':'ADMIDATE', 'ignore_cutoff': False},
             #{'table':'hes_apc_1920_','extra_columns':'','date_cutoff_col':'ADMIDATE', 'ignore_cutoff': True},
             {'table':'hes_ae_2021_','extra_columns':'','date_cutoff_col':'ARRIVALDATE', 'ignore_cutoff': False},
             #{'table':'hes_ae_1920_','extra_columns':'','date_cutoff_col':'ARRIVALDATE', 'ignore_cutoff': True},
             #{'table':'hes_op_1920_','extra_columns':'','date_cutoff_col':'APPTDATE', 'ignore_cutoff': True},
             {'table':'hes_op_2021_','extra_columns':'','date_cutoff_col':'APPTDATE', 'ignore_cutoff': False},
             #{'table':'hes_cc_1920_','extra_columns':'','date_cutoff_col':'ADMIDATE', 'ignore_cutoff': True},
             {'table':'hes_cc_2021_','extra_columns':'','date_cutoff_col':'ADMIDATE', 'ignore_cutoff': False}, 
             {'table':'primary_care_meds_','extra_columns':'','date_cutoff_col':'ProcessingPeriodDate', 'ignore_cutoff': False},
             {'table':'gdppr_','extra_columns':'','date_cutoff_col':'DATE', 'ignore_cutoff': False},
             {'table':'deaths_','extra_columns':", to_date(REG_DATE_OF_DEATH, 'yyyyMMdd') as REG_DATE_OF_DEATH_FORMATTED, to_date(REG_DATE, 'yyyyMMdd') as REG_DATE_FORMATTED",'date_cutoff_col':"REG_DATE_OF_DEATH_FORMATTED", 'ignore_cutoff': False},
             {'table':'sgss_','extra_columns':'','date_cutoff_col':'Specimen_Date', 'ignore_cutoff': False},
             {'table':'sus_','extra_columns':'','date_cutoff_col':'EPISODE_START_DATE', 'ignore_cutoff': False},
