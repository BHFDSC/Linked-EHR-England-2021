...
# MAGIC                   FROM .dp_patient_fields_ranked_pre_cutoff eth
...
# MAGIC 
# MAGIC WITH CTE as (SELECT NHS_NUMBER_DEID, Source FROM .dp_firststroke_event_table )
# MAGIC 
# MAGIC SELECT pat.*, 
...
# MAGIC 
# MAGIC WITH CTE as (SELECT NHS_NUMBER_DEID, Source FROM .dp_firstmi_event_table )
# MAGIC 
# MAGIC SELECT pat.*, 
...
# MAGIC 
# MAGIC WITH CTE as (SELECT NHS_NUMBER_DEID, Source FROM .dp_covid19_test_all3 )
# MAGIC 
# MAGIC SELECT pat.*, 
...
# MAGIC     LEFT JOIN (SELECT DISTINCT PERSON_ID_DEID as DEC_CONF_NHS_NUMBER_CLEAN_DEID FROM .dp_covid_death) covid_death ON pat.NHS_NUMBER_DEID = covid_death.DEC_CONF_NHS_NUMBER_CLEAN_DEID
