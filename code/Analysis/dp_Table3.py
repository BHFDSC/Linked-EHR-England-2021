...
# MAGIC from .dp_covid19_test_all3 covid_sgss_gdppr
# MAGIC FULL OUTER JOIN
# MAGIC   .dp_covid_cc_death_flags covid_hes_cc_deaths ON covid_sgss_gdppr.nhs_number_deid = covid_hes_cc_deaths.PERSON_ID_DEID -- this table comes from "COVID-19 testing table_updated" notebook
# MAGIC )
...
# MAGIC FROM .descriptive_mi_previous_distinct_table previous
...
# MAGIC cte_join as (
# MAGIC SELECT previous.*, covid.*
# MAGIC FROM .descriptive_stroke_previous_distinct_table previous
# MAGIC LEFT JOIN cte_covid covid ON previous.PERSON_ID_DEID = covid.id
# MAGIC ),
# MAGIC 
# MAGIC query as (
...
# MAGIC FROM .covariate_flags_diabetes diabetes
...
# MAGIC FROM .covariate_flags_obesity obesity
